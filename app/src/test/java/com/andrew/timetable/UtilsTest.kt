...
class UtilsTest {
  ...
  class NoTime {
    companion object {
      const val get_lesson_time_left = "   --:--  "
      const val get_pairs_time_left = "      --:--  "
      const val get_time_until_next_lesson = "     --:--"
      const val get_time_until_next_pair = "     --:--"
    }
  }
  ...
  @Test
  fun test_get_lesson_time_left_during_other_times() {
    arrayOf(
      "0:00",
      "4:00",
      "8:29",
      ...
      assertEquals(
        NoTime.get_lesson_time_left,
        utils.get_lesson_time_left(Time.from_hhmm(hhmm))
      )
    }
  }

  @Test
  fun test_get_lesson_time_left_during_recess() {
    for (i in 1 until utils.timings.size - 1 step 2) {
      arrayOf(
        ...
        assertEquals(
          NoTime.get_lesson_time_left,
          utils.get_lesson_time_left(get_time(i, offset))
        )
      }
    }
  }
  ...
  @Test
  fun test_get_lesson_time_left_during_study_time() {
    for (i in 0 until utils.timings.size - 1 step 2) {
      mapOf(
        ...
        assertEquals(
          expected_time(x),
          utils.get_lesson_time_left(get_time(i, y))
        )
      }
    }
  }
  ...
  @Test
  fun test_get_time_until_next_lesson_during_1st_lesson_of_pair() {
  ...
  @Test
  fun test_get_time_until_next_lesson_during_2nd_lesson_of_pair() {
    for (i in 2 until utils.timings.size - 5 step 4) {
      val pair = utils.get_pair(get_time(i))
      when (pair!!.pair) {
        3 -> mapOf(
          "1:15" to "0:00", // 45 + 30
          "1:14" to "0:01",
  ...
  @Test
  fun test_get_time_until_next_lesson_during_recess_that_is_during_a_pair() {
  ...
  @Test
  fun test_get_time_until_next_lesson_during_recess_between_pairs() {
  ...
  // --------------------------|get_pair_time_left()|---------------------------
  @Test
  fun test_get_pairs_time_left_no_time_during_other_times() {
    arrayOf(
      "0:00",
      "4:00",
      "8:29",
      ...
      assertEquals(
        NoTime.get_pairs_time_left,
        utils.get_pairs_time_left(Time.from_hhmm(hhmm))
      )
    }
  }

  @Test
  fun test_get_pairs_time_left_no_time_during_recess_between_pairs() {
    for (i in 3 until utils.timings.size step 4) {
      arrayOf(
        ...
        assertEquals(
          NoTime.get_pairs_time_left,
          utils.get_pairs_time_left(get_time(i, offset))
        )
      }
    }
  }
  ...
  @Test
  fun test_get_pairs_time_left_during_recess_that_is_during_a_pair() {
    for (i in 1 until utils.timings.size - 2 step 4) {
      val recess = utils.get_recess(get_time(i))
      if (recess!!.pair >= 6) break
      mapOf(
        "0:50" to "0:00", // 5 + 45
        "0:49" to "0:01",
        "0:48" to "0:02",
        ...
        assertEquals(
          expected_time(x),
          utils.get_pairs_time_left(get_time(i, y))
        )
      }
    }
  }
  ...
  @Test
  fun test_get_pairs_time_left_during_1st_lesson_of_pair() {
    for (i in 0 until utils.timings.size - 3 step 4) {
      mapOf(
  ...
  @Test
  fun test_get_pairs_time_left_during_2nd_lesson_of_pair() {
  ...
  // -----------------------|get_time_until_next_pair()|------------------------
  @Test
  fun test_get_time_until_next_pair_before_study_time() {
    mapOf(
      "8:30" to "0:00",
      "4:30" to "4:00",
      "0:01" to "8:29",
      ...
      assertEquals(
        expected_time(x),
        utils.get_time_until_next_pair(Time.from_hhmm(y))
      )
    }
  }

  @Test
  fun test_get_time_until_next_pair_after_study_time() {
    val last_index = utils.timings.size - 1
    for (i in 3 downTo 0) {
      assertEquals(
        NoTime.get_time_until_next_pair,
        utils.get_time_until_next_pair(get_time(last_index - i))
      )
    }
    arrayOf(
      "19:25",
      ...
      assertEquals(
        NoTime.get_time_until_next_pair,
        utils.get_time_until_next_pair(Time.from_hhmm(hhmm))
      )
    }
  }

  @Test
  fun test_get_time_until_next_pair_during_1st_lesson_of_pair() {
    for (i in 0 until utils.timings.size - 7 step 4) {
      ...
      when (pair!!.pair) {
        ...
        assertEquals(
          expected_time(x),
          utils.get_time_until_next_pair(get_time(i, y))
        )
      }
    }
  }
  ...
  @Test
  fun test_get_time_until_next_pair_during_2nd_lesson_of_pair() {
    for (i in 2 until utils.timings.size - 5 step 4) {
      val pair = utils.get_pair(get_time(i))
      when (pair!!.pair) {
        3 -> mapOf(
  ...
  @Test
  fun test_get_time_until_next_pair_during_recess_between_pairs() {
    for (i in 3 until utils.timings.size - 4 step 4) {
      val recess = utils.get_recess(get_time(i))
      when (recess!!.pair) {
        3 -> mapOf(
  ...
  @Test
  fun test_get_time_until_next_pair_during_recess_that_is_during_a_pair() {
